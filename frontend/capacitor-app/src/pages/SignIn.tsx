  ...
  return (
    <MobileLayout hideNav className="flex flex-col px-6 py-12 relative">
      ...
      <div className="space-y-3 flex flex-col items-center w-full">
        ...
        {/* Custom Mobile-Friendly Google Login Button */}
        <button
          type="button"
          onClick={() => handleOAuthClick('Google')}
          id="google-oauth-btn"
          className="w-full max-w-[320px] flex items-center justify-center gap-3 bg-white hover:bg-white/95 active:bg-white/90 text-black font-semibold py-3 px-4 rounded-xl shadow-md transition-all border border-slate-200"
        >
